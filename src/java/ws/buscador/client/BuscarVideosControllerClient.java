 ...
 * @author Alex
 */
@WebServlet(name = "BuscarVideosControllerClient", urlPatterns = {"/BuscarVideosControllerClient"})
public class BuscarVideosControllerClient extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (result.isEmpty()) {
                RequestDispatcher rd = getServletContext().getRequestDispatcher("/buscarVideos.jsp");
                ...
                RequestDispatcher view = request.getRequestDispatcher("buscarVideos.jsp");
                view.forward(request, response);
            }
        } catch (ClassNotFoundException_Exception | ServletException | IOException ex) {
            Logger.getLogger(BuscarVideosControllerClient.class.getName()).log(Level.SEVERE, null, ex);
        }
